resource "azurerm_virtual_network" "vnet" {
  ...
  dns_servers             = each.value.dns_servers             #Optional Argument
  bgp_community           = each.value.bgp_community           #Optional Argument
  edge_zone               = each.value.edge_zone               #Optional Argument
  flow_timeout_in_minutes = each.value.flow_timeout_in_minutes #Optional Argument
  tags                    = each.value.tags                    #Optional Argument
